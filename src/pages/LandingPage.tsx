...
const maturityStates = [
  { name: "Frei", copy: "Der Appteil ist dokumentiert und kann übernommen werden.", color: "neutral" },
  ...
  { name: "Production Ready", copy: "Der Appteil ist geprüft, veröffentlicht und wird überwacht.", color: "green" },
] as const
    ...
    <div className="landing-page">
      ...
      <main>
        <section className="landing-hero">
          ...
          <p>Modulane zeigt, wer woran arbeitet, wie stabil ein Produktbereich ist und was noch bis zur Veröffentlichung fehlt. Ohne unnötige Aufgabenebene.</p>
          <div className="hero-actions"><Link className="landing-button" to={primaryTarget}>{primaryLabel}<ArrowRight size={16} /></Link><a className="landing-text-link" href="#product">Produkt ansehen<ArrowRight size={15} /></a></div>
        ...
        <section className="landing-product-stage" id="product" aria-label="Produktvorschau">
            ...
            <div className="window-body">
              ...
              <div className="window-content">
                ...
                <div className="window-detail-grid">
                  ...
                  <div className="window-properties"><p><span>Status</span><strong>In Arbeit</strong></p><p><span>Priorität</span><strong>Hoch</strong></p><p><span>Zustand</span><strong>In Entwicklung</strong></p><p><span>Appteil Lead</span><strong><i>MW</i>Moritz</strong></p></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="landing-intro" id="workflow">
          <div className="landing-section-label">Ein System für Produktklarheit</div>
          <h2>Software besteht aus Bereichen.<br />Modulane macht ihren Zustand sichtbar.</h2>
          <p>Von der ersten Idee bis zum stabilen Produktbereich bleibt alles an einem Ort. Personen, Anforderungen, Entscheidungen und relevante Codeänderungen.</p>
        </section>
        ...
        <section className="landing-principles">
          ...
          <article><span>02</span><Pulse size={21} /><h3>Reife ist eindeutig</h3><p>Arbeitsstatus und technische Stabilität haben eigene Zustände. Ein Appteil kann fertig entwickelt und trotzdem noch instabil sein.</p></article>
          <article><span>03</span><GitCommit size={21} /><h3>Code bleibt optional</h3><p>Verknüpfe Commits und Pull Requests nur dann, wenn sie wichtigen Kontext liefern. Der Produktbereich funktioniert auch ohne GitHub.</p></article>
        </section>

        <section className="maturity-section">
          <div className="maturity-copy"><span className="landing-section-label">Technische Reife</span><h2>Ein Zustand, den das ganze Team versteht.</h2><p>Modulane trennt den Fortschritt der Arbeit vom Zustand des Produkts. Das verhindert falsche Sicherheit und macht Übergaben klar.</p><Link className="landing-text-link" to={primaryTarget}>Im Produkt ausprobieren<ArrowRight size={15} /></Link></div>
        ...
        <section className="code-section-landing" id="code">
          <div className="code-section-copy"><span className="landing-section-label">Produkt und Code</span><h2>Genug technischer Kontext. Kein Zwang.</h2><p>Commits ergänzen einen Appteil, ohne ihn in ein Entwicklerwerkzeug zu verwandeln. Repository, Branch und Code Link bleiben sauber zugeordnet.</p><div className="code-benefits"><span><Check size={13} weight="bold" />Commits gezielt hinzufügen</span><span><Check size={13} weight="bold" />Repository pro Projekt</span><span><Check size={13} weight="bold" />Direkte Links zum Code</span></div></div>
          <div className="landing-code-preview">
            ...
            <div className="landing-commit"><code>7c31a9f</code><span><strong>Anmeldeformular und Validierung ergänzen</strong><small>feature/anmeldung&nbsp;&nbsp;/&nbsp;&nbsp;Lina Becker</small></span><ArrowUpRight size={15} /></div>
